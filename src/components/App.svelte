...
<main>
	...
	<div class="control" class:hidden aria-hidden={hidden}>
		...
		<div class="small"><a target="_blank" rel="noopener noreferrer" href="https://github.com/ralozkolya/screen-check-svelte"><i class="icon-github-circled"></i>Source</a></div>
	</div>
</main>
